...
public partial class PageFuncionarioUpdate : ContentPage
{
	public PageFuncionarioUpdate(FuncionarioViewModel page, UsuarioModelRequeste funcionario)
	{
		InitializeComponent();
		this.BindingContext = new CadFuncViewModel(page, funcionario);
	}
